...
function AboutHeader() {
  const cvDownload = () => {
    console.log("hello");
    saveAs("/cv/cv.pdf", "htetnaing_CV.pdf");
  };
  return (
      ...
      <div className=" grid grid-cols-8 rounded-lg text-[20px]  sm:col-start-2 mt-12  sm:col-span-10 md:col-start-3 md:col-span-8 lg:col-start-4 lg:col-span-6 bg-secondary border border-secondary ">
        <div className="col-start-1 col-span-8 md:col-start-3 md:col-span-4  ">
          <div className="flex flex-col justify-center items-center gap-4  py-7">
            ...
            <button
              onClick={cvDownload}
              className="mt-1.5 text-secondary-font-color hover:cursor-pointer hover:text-third-font-color hover:border-primary hover:border hover:rounded-sm border rounded-sm bg-primary border-secondary font-medium text-[16px] py-2.5 px-5.5"
            >
              Resume Download
            </button>
          </div>
